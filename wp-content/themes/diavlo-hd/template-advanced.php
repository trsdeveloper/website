...
<div class="header fullscreen-maybe">
  	...
  	<?php i3d_show_widget_region("showcase", array("fullscreen-slider-wrapper container-wrapper", "container")); ?> 		

<div class="top">
<?php i3d_show_widget_region("utility", array("container", "row inner")); ?>

<?php // i3d_show_widget_region("header-lower", array());  // header lower used for top menu ?>
